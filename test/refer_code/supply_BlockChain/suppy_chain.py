...
# The algorithm requires to find SHA256 of a natural number (string)
# such that has the first three positions as '000' and ends with '00'
def generate_pow():
...
# Smart contract for checking if the input item code is avaiable on the blockchain &
# checking the previous owner of the consignment
